        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ServiceInfo = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
            ...
            migrationBuilder.InsertData(
                table: "Employees",
                columns: new[] { "Id", "AppliedPromocodesCount", "Email", "FirstName", "LastName", "Phone", "RoleId" },
                values: new object[,]
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("cb98e283-fcb0-4baa-8541-39ffe9a3fe38"), new DateTime(2025, 7, 21, 15, 49, 52, 388, DateTimeKind.Local).AddTicks(5718), "TOY20", new Guid("a6c8c6b1-4349-45b0-ab31-244740aaf0f0"), new DateTime(2025, 8, 4, 15, 49, 52, 389, DateTimeKind.Local).AddTicks(9365), "GameLand", new Guid("76324c47-68d2-472d-abb8-33cfa8cc0c84"), "Скидка 20% на игрушки" });
